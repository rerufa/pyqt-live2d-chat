...
export class LAppView {
  ...
  // on custom event
  public onCustomEvent(eventName: string, value: number): void {
    const live2DManager: LAppLive2DManager = LAppLive2DManager.getInstance();
    if (eventName == "mouth") {
      live2DManager.onCustomEvent(eventName, value)
    } else if (eventName == "top"){
      live2DManager.onDrag(100, 100)
    } else if (eventName == "bottom"){
      live2DManager.onDrag(-100, -100)
    }
  }
